...
INSERT INTO `block_bank_card` VALUES (2, '2020-08-13 01:19:13', 'ewqe', 'qwe', 'wefq', 1, 'we');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `qrtz_scheduler_state` VALUES ('quartzScheduler', 'zhangyindeMacBook-Pro.local1597292406646', 1597302342550, 15000);
COMMIT;
...
CREATE TABLE `quartz_job` (
  ...
  `status` tinyint DEFAULT NULL COMMENT '任务状态，0：暂停，1：正常',
...
CREATE TABLE `quartz_job_log` (
  ...
  `method_name` varchar(100) DEFAULT NULL COMMENT '方法名',
  `params` varchar(2000) DEFAULT NULL COMMENT '参数',
  `status` tinyint NOT NULL COMMENT '任务状态 0：失败 1：成功',
...
CREATE TABLE `sys_area` (
  ...
  `layer` int DEFAULT NULL COMMENT '层级',
  `order_num` int DEFAULT NULL COMMENT '排序号,1:省级,2:地市,3:区县',
  `status` tinyint DEFAULT NULL COMMENT '显示,1:显示,0:隐藏',
...
INSERT INTO `sys_log` VALUES (80, 1, 'admin', '登录', 17, 'com.bottle.pay.modules.sys.controller.SysLoginController.login()', '{}', '0:0:0:0:0:0:0:1', '2020-08-13 10:51:58');
INSERT INTO `sys_log` VALUES (81, 1, 'admin', '登录', 23, 'com.bottle.pay.modules.sys.controller.SysLoginController.login()', '{}', '0:0:0:0:0:0:0:1', '2020-08-13 11:52:57');
INSERT INTO `sys_log` VALUES (82, 1, 'admin', '登录', 29, 'com.bottle.pay.modules.sys.controller.SysLoginController.login()', '{}', '0:0:0:0:0:0:0:1', '2020-08-13 12:21:23');
INSERT INTO `sys_log` VALUES (83, 1, 'admin', '登录', 21, 'com.bottle.pay.modules.sys.controller.SysLoginController.login()', '{}', '0:0:0:0:0:0:0:1', '2020-08-13 15:02:24');
COMMIT;
...
CREATE TABLE `sys_macro` (
  ...
  `type_id` bigint DEFAULT NULL COMMENT '父级id',
  `name` varchar(50) DEFAULT NULL COMMENT '名称',
  `value` varchar(2000) DEFAULT NULL COMMENT '值',
  `status` tinyint DEFAULT '1' COMMENT '状态，0：隐藏   1：显示',
  `type` tinyint DEFAULT NULL COMMENT '类型,0:目录，1:参数配置',
...
CREATE TABLE `sys_org` (
  ...
  `order_num` int DEFAULT NULL COMMENT '排序',
  `status` tinyint DEFAULT '1' COMMENT '可用标识  1：可用  0：不可用',
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
  `gmt_modified` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`org_id`)
